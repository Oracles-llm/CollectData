...
Below is a sample program that consumes flyweight pattern implementation. `DrawingClient.java`
...
1. “Flyweight pattern implementation is not useful when the number of intrinsic properties of Object is huge, making implementation of Factory class complex.” how can object of high intrinsic properties can increase the complexity of the Factory. Since all the properties are getting initialized by the predefined values and are not passed from the factory. 2. “extrinsic properties of an Object should be defined by the client program.” Do you mean if an object has lots of extrinsic properties, lets take around 100, then there is no point using the Flyweight pattern since we cant pass all this properties to flyweight factory.
